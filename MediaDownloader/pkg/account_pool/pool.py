...
class AccountPoolManager:
    ...
    def get_active_account(self) -> AccountInfoModel:
        ...
        # Rotate through accounts instead of removing them
        for i in range(len(self._account_list)):
            account = self._account_list[i]
            if account.status.value == AccountStatusEnum.NORMAL.value:
                # Move this account to the end of the list
                self._account_list.append(self._account_list.pop(i))
                utils.logger.info(
