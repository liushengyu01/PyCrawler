...
DOWNLOAD_MEDIA = True  # Whether to download media content
DOWNLOAD_VIDEO = True  # Whether to download videos
DOWNLOAD_IMAGE = True  # Whether to download images
DOWNLOAD_PATH = "downloads"  # Base download path
DOWNLOAD_TIMEOUT = 30  # Download timeout in seconds
DOWNLOAD_RETRY = 3  # Number of download retries
DOWNLOAD_CHUNK_SIZE = 1024 * 1024  # Download chunk size in bytes

# Bilibili specific download configuration
BILI_VIDEO_QUALITY = 80  # Video quality (80: 1080P, 64: 720P, 32: 480P, 16: 360P)
BILI_VIDEO_FORMAT = "mp4"  # Video format (mp4, flv)
BILI_DOWNLOAD_COOKIES = True  # Whether to use cookies for download
